...
task :build do
  ...
  puts %x(rvm use jruby && jar ufe #{app_name}.jar org.jruby.JarBootstrapMain -C bin/ jar-bootstrap.rb -C bin/ screenshot.rb -C bin/ tray_application.rb -C bin/ selection_layer.rb)
